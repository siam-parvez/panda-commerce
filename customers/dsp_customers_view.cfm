                    ...
                    <tr>
                        <!--- <cfoutput query="getAllCustomersRecords"> --->
                            ...
                            <td class="flex">
                                ...
                                <form action="index.cfm" method="POST" name="DeleteCustomerForm" class="d-inline">
                                    <input type="hidden" name="fuseaction" value="DeleteCustomer">
                                    <input type="hidden" name="CustomerID" value="#CustomerID#">
                                    <input type="hidden" name="showCustomers" value="all">
                                    <input type="submit" class="d-none" id="deleteCustomerSubmit">
                                    <label class="action-btn delete-btn" for="deleteCustomerSubmit">
                                        <svg class="inline-block" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <script>
                                        Swal.fire({
                                            ...
                                            confirmButtonColor: "##2416a2",
                                            confirmButtonText: 'Confirm',
                                            showCancelButton: true,
                                            cancelButtonColor: "##2416a2",
